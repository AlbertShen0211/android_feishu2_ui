...
public class MenuFragment8 extends BaseFragment {
    ...
    public static MenuFragment8 newInstance(String param) {
        MenuFragment8 fragment = new MenuFragment8();
