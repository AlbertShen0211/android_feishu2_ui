...
public class MenuFragment0 extends BaseFragment {
    ...
    public static MenuFragment0 newInstance(String param) {
        MenuFragment0 fragment = new MenuFragment0();
