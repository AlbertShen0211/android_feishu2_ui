...
import com.android.ctmanager.widget.dialog.widget.internal.BaseAlertDialog;
...
//        mLlContainer.setBackgroundDrawable(CornerUtils.INSTANCE.cornerDrawable(mBgColor, radius));
//        mTvBtnLeft.setBackgroundDrawable(CornerUtils.INSTANCE.btnSelector(radius, mBgColor, mBtnPressColor, 0));
//        mTvBtnRight.setBackgroundDrawable(CornerUtils.INSTANCE.btnSelector(radius, mBgColor, mBtnPressColor, 1));
//        mTvBtnMiddle.setBackgroundDrawable(CornerUtils.INSTANCE.btnSelector(mBtnNum == 1 ? radius : 0, mBgColor, mBtnPressColor, -1));
