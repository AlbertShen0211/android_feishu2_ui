package com.android.ctmanager.widget.dialog.widget.internal;
...
import com.android.ctmanager.widget.dialog.listener.OnBtnClickL;
import com.android.ctmanager.widget.dialog.widget.base.BaseDialog;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    /** btn text(按钮内容) */
    public String mBtnLeftText = "取消";
    public String mBtnRightText = "确定";
    public String mBtnMiddleText = "继续";
    /** btn textcolor(按钮字体颜色) */
    public int mLeftBtnTextColor;
    public int mRightBtnTextColor;
   // BaseApplication.Companion.getInstance().getResources().getColor(R.color.colorTest);
