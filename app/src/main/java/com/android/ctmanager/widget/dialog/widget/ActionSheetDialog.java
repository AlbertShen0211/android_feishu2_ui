package com.android.ctmanager.widget.dialog.widget;
...
import com.android.ctmanager.widget.dialog.entity.DialogMenuItem;
import com.android.ctmanager.widget.dialog.listener.OnOperItemClickL;
import com.android.ctmanager.widget.dialog.widget.base.BottomBaseDialog;
//import com.android.ctmanager.widget.dialog.utils.CornerUtils;
...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
     ...
     */
    private int mItemTextColor = Color.parseColor("#000000");
    //private int mItemTextColor1 = Color.parseColor("#00B35E");
    /**
     ...
     */
    private int mCancelTextColor = Color.parseColor("#000000");
    /**
...
//        mTvTitle.setBackgroundDrawable(CornerUtils.INSTANCE.cornerDrawable(mTitleBgColor, new float[]{radius, radius, radius,
//                radius, 0, 0, 0, 0}));
      ...
      //  mTvCancel.setBackgroundDrawable(CornerUtils.INSTANCE.listItemSelector(radius, mLvBgColor, mItemPressColor, 1, 0));
...
//        if (mIsTitleShow) {
//            mLv.setBackgroundDrawable(CornerUtils.INSTANCE.cornerDrawable(mLvBgColor, new float[]{0, 0, 0, 0, radius, radius, radius,
//                    radius}));
//        } else {
//            mLv.setBackgroundDrawable(CornerUtils.INSTANCE.cornerDrawable(mLvBgColor, radius));
//        }
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (1 == position) {
                mItemTextColor = Color.parseColor("#00B35E");
            }
            ...
            float radius = dp2px(mCornerRadius);
//            if (mIsTitleShow) {
//                llItem.setBackgroundDrawable((CornerUtils.INSTANCE.listItemSelector(radius, Color.TRANSPARENT, mItemPressColor,
